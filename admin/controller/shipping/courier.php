...
class ControllerShippingCourier extends Controller {
	...
	public function index() {
		...
		$data['action'] = $this->url->link('shipping/courier', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['courier_delivery_price'])) {
			$data['courier_delivery_price'] = $this->request->post['courier_delivery_price'];
		} else {
			$data['courier_delivery_price'] = $this->config->get('courier_delivery_price');
		}
